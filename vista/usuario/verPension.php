				...
				<div class="sidebar">
					...
					<div class="widget user text-center">
						...
						<ul class="list-inline mt-20">
							<li class="list-inline-item"><a href="" class="btn btn-contact d-inline-block  btn-primary px-lg-5 my-1 px-md-3">Editar</a></li>
							<li class="list-inline-item"><a href="" class="btn btn-offer d-inline-block btn-primary ml-n1 my-1 px-lg-4 px-md-3">Eliminar pensión</a></li>
						</ul>
					</div>
				</div>
			</div>
