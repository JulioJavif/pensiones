				...
				<div class="advance-search">
					<form>
						<div class="form-row">
							...
							<div class="form-group col-md-3">
								<input type="text" class="form-control my-2 my-lg-0" id="inputLocation4" placeholder="Barrio">
							</div>
			...
			<div class="col-md-3">
				<div class="category-sidebar">
                    ...
                    <div class="widget price-range w-100">
                        ...
                        <div class="block">
                            <input class="range-track w-100" type="text" data-slider-min="0" data-slider-max="700000" data-slider-step="7"
